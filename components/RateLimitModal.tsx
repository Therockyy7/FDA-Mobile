...
interface RateLimitModalProps {
  ...
  onClose: () => void;
  onRetry: () => void;
  /** Override default title (defaults to t("common.rateLimit.title")) */
  title?: string;
  /** Override default message (defaults to t("common.rateLimit.message")) */
  message?: string;
}
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.modalContent, { backgroundColor: colors.cardBg }]}>
          ...
          <Text style={[styles.title, { color: colors.text }]}>
            {title ?? t("common.rateLimit.title")}
          </Text>

          <Text style={[styles.description, { color: colors.subtext }]}>
            {message ?? t("common.rateLimit.message")}
          </Text>
          ...
          >
            ...
            >
              ...
              <Text style={styles.retryText}>
                {canRetry
                  ? t("common.rateLimit.retryNow")
                  : t("common.rateLimit.retryIn", { seconds: secondsLeft })}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
