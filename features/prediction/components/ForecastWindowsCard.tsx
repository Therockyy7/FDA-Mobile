  ...
  return (
    <View style={{
      ...
      <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 14, gap: 8 }}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 13, fontWeight: "800", color: text }}>Dự báo theo giờ</Text>
          <Text style={{ fontSize: 11, color: muted }}>Cập nhật lúc {evalStr}</Text>
        </View>
      </View>
      ...
      <View style={{ flexDirection: "row", gap: 8 }}>
        {windows.map((w) => {
          ...
          return (
            ...
            >
              <Text style={{ fontSize: 18, fontWeight: "900", color: color }}>{prob}%</Text>
              <Text style={{ fontSize: 11, fontWeight: "700", color: text, textAlign: "center" }}>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, fontWeight: "700", color: muted }}>+{w.horizon}</Text>
              </View>
            </View>
          );
        })}
