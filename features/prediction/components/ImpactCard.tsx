...
export function ImpactCard({ aiPrediction }: Props) {
  ...
  const recColor = rec.includes("🟢") ? "#10B981"
    : rec.includes("🟡") ? "#F59E0B"
    : rec.includes("🟠") ? "#EA580C"
    : rec.includes("🔴") ? "#EF4444"
    : "#64748B";
  ...
  return (
    <View style={{
      ...
      <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 14, gap: 8 }}>
        ...
        <Text style={{ fontSize: 13, fontWeight: "800", color: text }}>Đánh giá tác động</Text>
      </View>
      ...
      <View style={{
        ...
        borderLeftWidth: 3, borderLeftColor: recColor,
        marginBottom: 12,
      }}>
        <Text style={{ fontSize: 13, fontWeight: "700", color: recColor }}>{rec}</Text>
      </View>

      {/* Metrics row */}
      <View style={{ flexDirection: "row", gap: 10 }}>
        <View style={{ flex: 1, backgroundColor: sub, borderRadius: 14, padding: 12, alignItems: "center" }}>
          <View style={{
          ...
          <Text style={{ fontSize: 10, color: muted, textAlign: "center", marginTop: 2 }}>
            Độ sâu ước tính
          </Text>
        </View>
        <View style={{ flex: 1, backgroundColor: sub, borderRadius: 14, padding: 12, alignItems: "center" }}>
